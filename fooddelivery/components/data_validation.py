from fooddelivery.entity.artifact_entity import DataIngestionArtifact, DataValidationArtifact
from fooddelivery.entity.config_entity import DataValidationConfig
...
class DataValidation:
    ...
    def initiate_data_validation(self) -> DataIngestionArtifact:
        try:
            ...
            # Validate if categorical columns exist
